  ...
  if (kIsWeb) {
    await Firebase.initializeApp(
        options: const FirebaseOptions(
            apiKey: "AIzaSyD9JHgRO1rtYYf2v1oMd3ZbxxUOw7w0bAY",
            authDomain: "champ-quizz.firebaseapp.com",
            projectId: "champ-quizz",
            storageBucket: "champ-quizz.firebasestorage.app",
            messagingSenderId: "136763257653",
            appId: "1:136763257653:android:aa72e7b9d444f3cdacd27c",
            measurementId: ""));
  } else {
    await Firebase.initializeApp();
  }
